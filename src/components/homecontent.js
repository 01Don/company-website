  ...
  return (
    <div className='home-content'>
      <div className='home-text'>
         <h1 className='head-text'>Unlock Your Ideal Living Space</h1>
         <p className='para-text'>Browse Diverse Real Estate Options Tailored to Your 
            Lifestyle.Discover a myriad of real estate 
            opportunities thoughtfully curated to suit your 
